...
echo "🚀 Starting JtnTech Cloud Spanner Automation..."

curl -LO https://raw.githubusercontent.com/JtnTech/Cloud-Spanner---Loading-Data-and-Performing-Backups/refs/heads/main/jtntech.sh

chmod +x jtntech.sh
./jtntech.sh
```
> **Tip**: copy above command and quick install...
...
echo "${CYAN_TEXT}${BOLD_TEXT}        🚀 WELCOME TO JtnTech 🚀        ${RESET_FORMAT}"
echo "${MAGENTA_TEXT}${BOLD_TEXT}══════════════════════════════════════════════${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}══════════════════════════════════════════════${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}📢 Follow for more${RESET_FORMAT}"
echo "${YELLOW_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}👉 https://www.youtube.com/@JatinTrails/videos${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}🙏 Thanks for using JtnTech 🚀${RESET_FORMAT}"
```
