# 🚀 JtnTech GCP Kubernetes Deployment Script

Welcome to **JtnTech GitHub** 👋  
This repository contains **Bash-based CLI automation scripts** to deploy the **Google Cloud Microservices Demo** on **Google Kubernetes Engine (GKE)** with logging and health checks.
...
echo
echo "${BLUE}${BOLD}╔══════════════════════════════════════════╗${NC}"
echo "${BLUE}${BOLD}║    WELCOME TO JtnTech GITHUB     ║${NC}"
echo "${BLUE}${BOLD}╚══════════════════════════════════════════╝${NC}"
echo
