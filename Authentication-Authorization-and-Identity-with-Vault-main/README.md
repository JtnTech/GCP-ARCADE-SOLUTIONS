...
# Welcome message with JtnTech reference
...
# Final message with JtnTech references
echo
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}        HASHICORP VAULT LAB COMPLETED SUCCESSFULLY!    ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}Welcome to JtnTech Repo${RESET_FORMAT}"

echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Thank you for following JtnTech ${RESET_FORMAT}"
echo
